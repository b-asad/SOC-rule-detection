# SEC-TECH-LM-001 — Technology: Pass-the-Hash / RDP Lateral Movement

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-TECH-LM-001` |
| **MITRE Tactic** | Lateral Movement |
| **Sector** | **Technology** |
| **Severity** | See base rule `GEN-LM-001` — apply same severity |
| **Priority** | See base rule `GEN-LM-001` |
| **MS Tools** | Sentinel · Defender XDR · Defender for Endpoint |
| **Log Source** | See `GEN-LM-001` |
| **Sector Context** | Developer workstations, CI/CD servers, cloud management hosts |
| **Regulatory** | SOC 2, ISO 27001 |

## Description

This rule applies the `GEN-LM-001` detection logic scoped to **Technology** infrastructure — restricting detection to hosts and systems specific to this sector using the watchlist and naming patterns below. The full KQL, investigation guide, and response actions from `GEN-LM-001` apply; this file adds the sector-specific host scope, context, and regulatory obligations.

**Deploy this rule in addition to `GEN-LM-001` — not instead of it.**

## Sentinel KQL — Sector-Scoped Variant

```kql
// SEC-TECH-LM-001 | Sector scope applied to GEN-LM-001
// Full query: copy from GEN-LM-001 and add the WHERE clause below
...
Alternatively, create a copy of the `GEN-LM-001` Sentinel Analytics Rule with:
- Rule name prefixed `SEC-TECH-LM-001`
...
Developer workstations, CI/CD servers, cloud management hosts are high-priority targets. Lateral Movement on these systems carries additional risk beyond the generic case:
...
Follow the `GEN-LM-001` investigation guide. Additional Technology-specific steps:
...
Follow `GEN-LM-001` response actions. Additional:
...
- Base rule: `GEN-LM-001` — full KQL and investigation guide
