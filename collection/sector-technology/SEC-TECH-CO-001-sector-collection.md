# SEC-TECH-CO-001 — Technology: Email Forwarding / Data Repository Collection

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-TECH-CO-001` |
| **MITRE Tactic** | Collection |
| **Sector** | **Technology** |
| **Severity** | See base rule `GEN-CO-001` — apply same severity |
| **Priority** | See base rule `GEN-CO-001` |
| **MS Tools** | Sentinel · Defender XDR · Defender for Endpoint |
| **Log Source** | See `GEN-CO-001` |
| **Sector Context** | Developer workstations, CI/CD servers, cloud management hosts |
| **Regulatory** | SOC 2, ISO 27001 |

## Description

This rule applies the `GEN-CO-001` detection logic scoped to **Technology** infrastructure — restricting detection to hosts and systems specific to this sector using the watchlist and naming patterns below. The full KQL, investigation guide, and response actions from `GEN-CO-001` apply; this file adds the sector-specific host scope, context, and regulatory obligations.

**Deploy this rule in addition to `GEN-CO-001` — not instead of it.**

## Sentinel KQL — Sector-Scoped Variant

```kql
// SEC-TECH-CO-001 | Sector scope applied to GEN-CO-001
// Full query: copy from GEN-CO-001 and add the WHERE clause below
...
Alternatively, create a copy of the `GEN-CO-001` Sentinel Analytics Rule with:
- Rule name prefixed `SEC-TECH-CO-001`
...
Developer workstations, CI/CD servers, cloud management hosts are high-priority targets. Collection on these systems carries additional risk beyond the generic case:
...
Follow the `GEN-CO-001` investigation guide. Additional Technology-specific steps:
...
Follow `GEN-CO-001` response actions. Additional:
...
- Base rule: `GEN-CO-001` — full KQL and investigation guide
