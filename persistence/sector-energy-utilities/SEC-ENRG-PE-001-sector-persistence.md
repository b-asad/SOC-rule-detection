# SEC-ENRG-PE-001 — Energy & Utilities: Registry Run Key / Account Persistence

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-ENRG-PE-001` |
...
```kql
// SEC-ENRG-PE-001 | Sector scope applied to GEN-PE-001
...
- Rule name prefixed `SEC-ENRG-PE-001`
...
OT engineering workstations, energy management hosts, control room PCs are high-priority targets. Persistence on these systems carries additional risk beyond the generic case:
...
Follow the `GEN-PE-001` investigation guide. Additional Energy & Utilities-specific steps:
