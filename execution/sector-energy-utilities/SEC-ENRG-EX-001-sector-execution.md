# SEC-ENRG-EX-001 — Energy & Utilities: PowerShell/WMI Execution on Sector Infrastructure

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-ENRG-EX-001` |
...
```kql
// SEC-ENRG-EX-001 | Sector scope applied to GEN-EX-001
...
- Rule name prefixed `SEC-ENRG-EX-001`
...
OT engineering workstations, energy management hosts, control room PCs are high-priority targets. Execution on these systems carries additional risk beyond the generic case:
...
Follow the `GEN-EX-001` investigation guide. Additional Energy & Utilities-specific steps:
