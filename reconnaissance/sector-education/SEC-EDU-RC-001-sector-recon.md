# SEC-EDU-RC-001 — Reconnaissance: Education Infrastructure Targeting

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-EDU-RC-001` |
...
Applies `GEN-RC-001` (active scanning) detection to infrastructure specific to the education sector, plus sector-specific threat intelligence feeds and targeted reconnaissance indicators.
...
The education sector faces targeted reconnaissance from:
