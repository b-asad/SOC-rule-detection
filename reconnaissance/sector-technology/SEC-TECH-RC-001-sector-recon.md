# SEC-TECH-RC-001 — Reconnaissance: Technology Infrastructure Targeting

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-TECH-RC-001` |
...
Applies `GEN-RC-001` (active scanning) detection to infrastructure specific to the technology sector, plus sector-specific threat intelligence feeds and targeted reconnaissance indicators.
...
The technology sector faces targeted reconnaissance from:
