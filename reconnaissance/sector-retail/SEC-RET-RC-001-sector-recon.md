# SEC-RET-RC-001 — Reconnaissance: Retail Infrastructure Targeting

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-RET-RC-001` |
...
Applies `GEN-RC-001` (active scanning) detection to infrastructure specific to the retail sector, plus sector-specific threat intelligence feeds and targeted reconnaissance indicators.
...
The retail sector faces targeted reconnaissance from:
