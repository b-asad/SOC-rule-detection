# SEC-FS-RC-001 — Reconnaissance: Financial-Services Infrastructure Targeting

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-FS-RC-001` |
...
Applies `GEN-RC-001` (active scanning) detection to infrastructure specific to the financial services sector, plus sector-specific threat intelligence feeds and targeted reconnaissance indicators.
...
The financial services sector faces targeted reconnaissance from:
