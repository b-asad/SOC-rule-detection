# SEC-HC-RC-001 — Reconnaissance: Healthcare Infrastructure Targeting

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-HC-RC-001` |
...
Applies `GEN-RC-001` (active scanning) detection to infrastructure specific to the healthcare sector, plus sector-specific threat intelligence feeds and targeted reconnaissance indicators.
...
The healthcare sector faces targeted reconnaissance from:
