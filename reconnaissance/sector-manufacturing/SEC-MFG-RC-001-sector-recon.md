# SEC-MFG-RC-001 — Reconnaissance: Manufacturing Infrastructure Targeting

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-MFG-RC-001` |
...
Applies `GEN-RC-001` (active scanning) detection to infrastructure specific to the manufacturing sector, plus sector-specific threat intelligence feeds and targeted reconnaissance indicators.
...
The manufacturing sector faces targeted reconnaissance from:
