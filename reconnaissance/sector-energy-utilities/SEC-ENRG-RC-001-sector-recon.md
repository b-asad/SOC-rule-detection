# SEC-ENRG-RC-001 — Reconnaissance: Energy-Utilities Infrastructure Targeting

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-ENRG-RC-001` |
...
Applies `GEN-RC-001` (active scanning) detection to infrastructure specific to the energy utilities sector, plus sector-specific threat intelligence feeds and targeted reconnaissance indicators.
...
The energy utilities sector faces targeted reconnaissance from:
