# SEC-ENRG-DE-001 — Energy & Utilities: Defender/AV Disabled on Sector Host

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-ENRG-DE-001` |
...
```kql
// SEC-ENRG-DE-001 | Sector scope applied to GEN-DE-001
...
- Rule name prefixed `SEC-ENRG-DE-001`
...
OT engineering workstations, energy management hosts, control room PCs are high-priority targets. Defense Evasion on these systems carries additional risk beyond the generic case:
...
Follow the `GEN-DE-001` investigation guide. Additional Energy & Utilities-specific steps:
