# SEC-TECH-CC-001 — Technology: C2 Beaconing from Sector Host

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-TECH-CC-001` |
...
```kql
// SEC-TECH-CC-001 | Sector scope applied to GEN-CC-001
...
- Rule name prefixed `SEC-TECH-CC-001`
...
Developer workstations, CI/CD servers, cloud management hosts are high-priority targets. Command and Control on these systems carries additional risk beyond the generic case:
...
Follow the `GEN-CC-001` investigation guide. Additional Technology-specific steps:
