# SEC-EDU-CC-001 — Education: C2 Beaconing from Sector Host

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-EDU-CC-001` |
...
```kql
// SEC-EDU-CC-001 | Sector scope applied to GEN-CC-001
...
- Rule name prefixed `SEC-EDU-CC-001`
...
Student/staff workstations, research systems, VLE servers are high-priority targets. Command and Control on these systems carries additional risk beyond the generic case:
...
Follow the `GEN-CC-001` investigation guide. Additional Education-specific steps:
