# SEC-LEG-CC-001 — Legal: C2 Beaconing from Sector Host

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-LEG-CC-001` |
...
```kql
// SEC-LEG-CC-001 | Sector scope applied to GEN-CC-001
...
- Rule name prefixed `SEC-LEG-CC-001`
...
Fee-earner workstations, DMS hosts, matter management servers are high-priority targets. Command and Control on these systems carries additional risk beyond the generic case:
...
Follow the `GEN-CC-001` investigation guide. Additional Legal-specific steps:
