# SEC-GOV-CC-001 — Government: C2 Beaconing from Sector Host

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-GOV-CC-001` |
...
```kql
// SEC-GOV-CC-001 | Sector scope applied to GEN-CC-001
...
- Rule name prefixed `SEC-GOV-CC-001`
...
Government workstations, policy systems, restricted infrastructure are high-priority targets. Command and Control on these systems carries additional risk beyond the generic case:
...
Follow the `GEN-CC-001` investigation guide. Additional Government-specific steps:
