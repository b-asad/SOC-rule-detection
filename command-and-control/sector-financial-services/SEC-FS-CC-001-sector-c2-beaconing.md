# SEC-FS-CC-001 — Financial Services: C2 Beaconing from Sector Host

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-FS-CC-001` |
...
```kql
// SEC-FS-CC-001 | Sector scope applied to GEN-CC-001
...
- Rule name prefixed `SEC-FS-CC-001`
...
Trading workstations, banking systems, core banking hosts are high-priority targets. Command and Control on these systems carries additional risk beyond the generic case:
...
Follow the `GEN-CC-001` investigation guide. Additional Financial Services-specific steps:
