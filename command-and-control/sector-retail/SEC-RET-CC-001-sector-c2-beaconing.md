# SEC-RET-CC-001 — Retail: C2 Beaconing from Sector Host

| Field | Value |
|-------|-------|
| **Rule ID** | `SEC-RET-CC-001` |
...
```kql
// SEC-RET-CC-001 | Sector scope applied to GEN-CC-001
...
- Rule name prefixed `SEC-RET-CC-001`
...
POS terminals, eCommerce hosts, store servers are high-priority targets. Command and Control on these systems carries additional risk beyond the generic case:
...
Follow the `GEN-CC-001` investigation guide. Additional Retail-specific steps:
